describe('Visual testing', () => {
    it('autograding markdown testing', () => {
        ...
        cy.get('[data-testid="autograding-results"]').compareSnapshot('autograding_code', 0.02, {
            capture: 'viewport',
...
describe('Visual testing 2', () => {
    it('autograding markdown testing', () => {
        ...
        cy.get('#nav-sidebar-collapse-sidebar').click();
        cy.get('[data-testid="details-tc-expand-all"]').click();
        cy.get('[data-testid="autograding-results"]').compareSnapshot('autograding_code-2', 0.02, {
            capture: 'viewport',
        });
        cy.get('[data-testid="test-box-block"]').scrollIntoView().should('be.visible');
        cy.get('[data-testid="test-box-block"]').compareSnapshot('autograding_code', 0.02, {
...
describe('Visual testing 2', () => {
    it('autograding markdown testing', () => {
        ...
        cy.get('[data-testid="test-box-block"]').scrollIntoView().should('be.visible');
        cy.get('[data-testid="test-box-block"]').compareSnapshot('autograding_code-3', 0.02, {
            capture: 'viewport',
        });
    });
});
...
describe('Visual testing 2', () => {
    it('autograding markdown testing', () => {
        ...
        cy.get('[data-testid="autograding-results"]').compareSnapshot('autograding_code-4', 0.02, {
            capture: 'viewport',
        });
        cy.get('[data-testid="test-box-block"]').scrollIntoView().should('be.visible');
        cy.get('[data-testid="test-box-block"]').compareSnapshot('autograding_code-3', 0.02, {
...
describe('Visual testing 2', () => {
    it('autograding markdown testing', () => {
        ...
        cy.get('#nav-sidebar-collapse-sidebar').click();
        cy.get('[data-testid="details-tc-expand-all"]').click();
        cy.get('body').scrollTo('center');
        cy.get('[data-testid="autograding-results"]').compareSnapshot('autograding_code-5', 0.02, {
            capture: 'viewport',
        });
    });
});
...
describe('Visual testing 2', () => {
    it('autograding markdown testing', () => {
        ...
        cy.get('[data-testid="details-tc-expand-all"]').click();
        cy.get('body').scrollTo('center');
        cy.get('body').compareSnapshot('autograding_code-6', 0.02, {
            capture: 'viewport',
        });
    });
});
